...
//       errors: {
//         message: "Spot can't be booked by the owner of the spot",
//       },
//     });
//   }
...
//       errors: {
//         startDate: "Start date cannot be the same as the end date",
//         endDate: "End date cannot be the same as the start date",
//       },
//     });
...
//         const startDateConflictWithExisting = await Booking.findOne({
//             where: {
//                 spotId,
//                 startDate: { [Op.eq]: startDate }
//             }
//         });
//         if (startDateConflictWithExisting) {
//             res.status(403).json({
//                 message: "Sorry, this spot is already booked for the specified dates",
//                 errors: {
//                     startDate: "Start date conflicts with an existing booking"
